                ...
                MyReference.GetStage = function(matrixJSON) {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            for(var x = 0; x < matrixJSON.Matrix.length; x++)
                            //for(var x in matrixJSON.Matrix)
                            {
                                var row = matrixJSON.Matrix[x];
                                ...
                                //for(var y in col)
                                {
                                    ...
                                    if(cell == BLOCK_TYPES.Names.Clear)
                                        posStatusType = _POSITION_STATUS_TYPES.Clear;
                                    else if(cell == BLOCK_TYPES.Names.Wall)
                                        posStatusType = _POSITION_STATUS_TYPES.Sealed;

                                    stage[y][x] = posStatusType;
                                }
                            }               
